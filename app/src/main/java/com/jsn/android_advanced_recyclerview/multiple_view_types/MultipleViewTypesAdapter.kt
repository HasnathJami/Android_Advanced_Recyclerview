...
import com.jsn.android_advanced_recyclerview.databinding.ItemUserListBinding
import com.jsn.android_advanced_recyclerview.model.userList
import com.jsn.android_advanced_recyclerview.user.UserListAdapter

class MultipleViewTypesAdapter(context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
...
//                }
            ...
            is ItemBannerViewHolder -> {
                Log.d("MultipleViewTypesAdapter", "Binding banner at position $position")
                holder.bannerIv.setImageResource(R.drawable.nature)
